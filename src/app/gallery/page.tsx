  ...
  return (
    <main className='w-full h-full'>
      ...
      <section className='w-full h-full flex flex-col items-center mt-10 mb-4'>
        ...
        <div className='w-full h-full px-8 grid md:grid-cols-2 lg:grid-cols-4 grid-cols-1 gap-6 mt-6'>
      ...
      <section className='w-full h-full flex flex-col items-center mt-10 mb-4'>
        ...
        <div className='w-full h-full px-8 grid md:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-6 mt-6'>
          {News.map((d: NewsType) => (
            <div
              className='w-full h-[400px] shadow-sm rounded-xl border p-4 flex flex-col gap-4'
              key={d.id}
